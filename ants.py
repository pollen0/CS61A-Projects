...
class Ant(Insect):
    ...
    def double(self):
        ...
        # BEGIN Problem 12
        if self.damage_doubler == False:
            self.damage *= 2
            self.damage_doubler = True
        # END Problem 12
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while current_place != None and (not current_place.is_hive):
            if len(current_place.bees) > 0 and self.upper_bound >= modified >= self.lower_bound:
    ...
    def action(self,gamestate):
        if self.turns_to_chew != 0:
            ...
            if len(current_place.bees) > 0:
                some_bee = random_bee(current_place.bees)
                some_bee.reduce_health(some_bee.health)
