...
def tail_points(opponent_score):
    ...
    if opponent_score < 100:
        ...
        secrightmost = opponent_score//10
        pigtail = 2 * abs(secrightmost-rightmost) + 1
    elif opponent_score >= 100:
        tens = opponent_score % 100
        rightmost = tens % 10
        ones = opponent_score // 10
        secrightmost = ones % 10
        pigtail = 2 * abs(secrightmost-rightmost) + 1
    return pigtail
    # END PROBLEM 2
...
def is_always_roll(strategy, goal=GOAL):
    ...
    while score0 < goal:
        score1 = 0
        while score1 < goal:
            if strategy(score0, score1) != strategy(score0 + 1, score1):
                return False
            score1 += 1
        score0 += 1
    return True
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    while n <= 10:
        ...
        current_high = average_score(n, dice)
